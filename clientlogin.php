...
?>
    ...
    <head>
        <title> Employee Login | Hertz </title>
    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="index.php">Hertz</a>
            </div>
        ...
        <div class="container">
            <div class="jumbotron">
                <h1 class="text-center">Hertz - Employee Panel </span>
                </h1>
                <br>
